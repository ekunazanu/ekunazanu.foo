...
{{ <picture src="/media/log/fractal-complex-plane.avif" alt="domain coloring of the complex plane" /> }}
...
{{ <picture src="/media/log/fractal-complex-addition.avif" alt="domain coloring for addition by 1, -1, and i" /> }}
{{ <picture src="/media/log/fractal-complex-exponentiation.avif" alt="domain coloring for simple complex quadratic functions" /> }}
...
{{ <picture src="/media/log/fractal-julia.avif" alt="group of julia sets with different parameters c" /> }}
...
{{ <picture src="/media/log/fractal-fatou.avif" alt="group of fatou dusts with different parameters c" /> }}
