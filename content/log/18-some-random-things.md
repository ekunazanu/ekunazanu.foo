...
Yes, updates are slowing shifting towards the end of the month, but I think it makes more sense this way. The posts can then (for me) act as a reflection of what I've done for the month. Or that is what I would have said if the posts actually were logs of what I got done for the month. Lately I have been wanting to post about things I find mildly interesting, instead of mundane things-that-I-got-done. Things that are too short and simple for [Lab](/lab), but interesting enough that I want to write about it.
