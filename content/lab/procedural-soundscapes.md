...
Music theory is based around these ratios, or [intervals](https://en.wikipedia.org/wiki/Interval_(music)). A frequency ratio of 2:1 is called a perfect octave. A ratio of 3:2 is a perfect fifth, 4:3 is a perfect fourth, and 5:4 is a major third. The smallest of the intervals is called a minor second or semitone, having a ratio of 16:15. The minor second, along with a [few other](https://en.wikipedia.org/wiki/Tritone) intervals sound [dissonant](https://en.wikipedia.org/wiki/Consonance_and_dissonance) since they do not have simple frequency ratios, but are still useful for creating [tension](https://en.wikipedia.org/wiki/Tension_(music)).
...
Similar to a scale, a [mode](https://en.wikipedia.org/wiki/Mode_(music)) is also an interval structure but without a specific root note.
...
The interval structure of a scale or mode defines its 'vibe'. A scale with dissonant intervals can sound jarring and tense, while a scale with a consonant intervals can sound upbeat and bright.
{% end %}
...
Chords can add more depth and texture to sounds than single-pitch notes. The scale, as well the a progression of chords can be selectively chosen to create sounds for evoking a specific mood.
...
The first beat is random, and does not necessarily sound pleasant. The second beat is periodic, and sounds slightly more pleasant but nonetheless sound monotonous and dull. The last beat sounds the most rhythmic. A way to make sounds more cadenced is to use a regular pulse beat, and [accentuate certain beats periodically](https://en.wikipedia.org/wiki/Metre_(music)). The [number](https://en.wikipedia.org/wiki/Time_signature) of [beats for every accentuated beat](https://en.wikipedia.org/wiki/Bar_(music)) is usually [three](https://en.wikipedia.org/wiki/Triple_metre) or [four](https://en.wikipedia.org/wiki/Duple_and_quadruple_metre#Quadruple_metre).
