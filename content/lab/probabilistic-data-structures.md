...
<input id="bfInputMultipleSlider" type="range" min="1" max="6" step="1">
...
<input id="bfInputBiggerAdd" value="hello"> <button id="bfButtonBiggerAdd">Add</button><br>
...
<input id="cmsInputComparisonQuery" value="foo"> <button id="cmsButtonComparisonQuery">Search</button><br>
Hash: <code id="cmsOutputComparisonHash">44, 242, 77</code><br>
Bloom Filter: <span id="cmsOutputComparisonMessage">&nbsp;</span><br>
Counting Bloom Filter counters: <span id="cmsOutputComparisonValues">0, 0, 0</span><br>
...
<canvas id="cmsCanvasAA"></canvas>
<input id="cmsInputAAAdd" value="hello"> <button id="cmsButtonAAAdd">Add</button><br>
<input id="cmsInputAAQuery" value="hello"> <button id="cmsButtonAAQuery">Search</button><br>
Hash: <code id="cmsOutputAAHash">44, 242, 77</code><br>
Counters: <span id="cmsOutputAAValues">0,0,0</span><br>
Frequency Estimate: <span id="cmsOutputAAValues">0</span>
