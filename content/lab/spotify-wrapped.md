...
So I manually downloaded all my data, and had a go at visualising it myself. You can try it with your data too.

<svg id="mainChart"></svg>

Personally, I think the [calendar plot](https://observablehq.com/@d3/calendar/2) is more data dense and gives deeper insights than listing top artists and top songs of the year. But there's also disadvantages  — the most obvious being that it will not scale well at all for smaller screens. But Spotify Wrapped is not available on desktops, so .

<script src="/scripts/spotify-wrapped.js"></script>
<!--
* Selection menu for:
