...
[extra]
type = "article"
thumbnail = "lab.grid.svg"
thumbnailalt = "A grid of purple-pink coloured squares."
+++
...
{{ loadData(path="/static/media/lab/neural-networks/.txt") }} <!-- u or intverted u shaped data -->
...
{{ loadData(path="/static/media/lab/neural-networks/.txt") }} <!-- u or intverted u shaped data, show dotted line for minimum cost -->
...
* Colour scheme:
    ...
    * Weights, Biases — green and orange (https://observablehq.com/@d3/parallel-coordinates)
-->
