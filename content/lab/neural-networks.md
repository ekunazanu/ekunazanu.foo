...
<canvas id="canvasTwoDimensionsLinearStatic"></canvas>
...
<canvas id="canvasTwoDimensionsLinearLineStatic"></canvas>
...
<canvas id="canvasTwoDimensionsLinear"></canvas>
<input id="sliderTwoDimensionsLinearW1" type="range"><br>
<input id="sliderTwoDimensionsLinearW2" type="range"><br>
...
<canvas id="canvasTwoDimensionsLinearLoss"></canvas>
<canvas id="canvasTwoDimensionsLinearLossPlots"></canvas>
<input id="sliderTwoDimensionsLinearLossW1" type="range"><br>
<input id="sliderTwoDimensionsLinearLossW2" type="range"><br>
...
<canvas id="canvasLossLandscapePlots"></canvas>
<button id="buttonLossLandscapeTrain">Train</button>
<canvas id="canvasLossLandscape"></canvas>
<input id="sliderLossLandscapeW1" type="range"><br>
<input id="sliderLossLandscapeW2" type="range"><br>
...
Show multiple dimensions relations using scatterplot matrix https://r2d3.us/visual-intro-to-machine-learning-part-1/ .
